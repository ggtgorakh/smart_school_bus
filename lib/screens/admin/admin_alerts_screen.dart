// lib/screens/admin/admin_alerts_screen.dart
//
// Emergency log + broadcast messaging. Available on both mobile and
// laptop for Admin. On mobile, only acknowledge/resolve are permitted.
...
class _AdminAlertsScreenState extends State<AdminAlertsScreen> {
  ...
  Widget build(BuildContext context) {
    final canBroadcast = isLaptopActionAllowed();
    return Scaffold(
            ...
            child: StreamBuilder<List<EmergencyEvent>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  return Center(
                    child: Text(
                      'Unable to load emergencies: ${snapshot.error}',
                    ),
                  );
                }
                if (!snapshot.hasData) {
  ...
  Widget _eventCard(BuildContext context, EmergencyEvent e) {
